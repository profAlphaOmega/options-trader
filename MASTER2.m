...
info.run_type = 'tradeopps'; % Create run_type variable
...
sendmail('ammodono@gmail.com', 'RUN_COMPLETE:',['Run Successful:' 10 10 ...
    'Start Time ' info.start_time_str 10 ...
    'End Time ' info.finish_time_str 10 10 ...
    'Go To Site http://genchaos.gotdns.com:2666/home.php' 10 ...
     ]); 
...
%% Error Handle
    ...
    sendmail('ammodono@gmail.com', 'ERROR: MASTER',['identifier: ' ME.identifier 10 'message: ' ME.message 10 'function path: ' ME.stack.file 10 'function name: ' ME.stack.name 10 'line: ' num2str(ME.stack.line)]);
end
end
